![Gatsby E-commerce theme designed by Ossai]

This beautiful theme from the [Ossai Design](https://ossaiproject.vercel.app/) gives you the styling and scaffolding for your next e-commerce site. You can customize to your heart's content and add the tooling for cart, transactions, product, and more. This theme uses:
...
This project is intended to be extended by you! We wanted to make possible to replace parts of it with your own tools and data sources. If you're interested on a direction, you can refer to Ossai [how to use section](https://gatsby-ecommerce-theme.netlify.app/how-to-use/) in this project or you may want to consider using [Ossai's toolset with their JAMM framework](https://ossaiproject.vercel.app/) which includes some projects like:
